...
def generate_auto_reflection_auto_adapt_prompt(question, previous_incorrect_answers, auto_prompt_model_name, auto_prompt_api_key, auto_prompt_api_provider, auto_prompt_supports_sampling_params, auto_prompt_thinking_effort_support=False, auto_prompt_reasoning_effort="medium", auto_prompt_temperature=1.0, auto_prompt_top_p=1.0):
    """
    ...
    adapted_reflection_prompt_instructions = query_model(
        ...
        temperature=auto_prompt_temperature,
        top_p=auto_prompt_top_p
    )
